...
public:
	...
	void SetTarget(fm::string& s) { targetPointer = s; }
	void SetTargetQualifier(fm::string& s){ targetQualifier = s; }

	fm::string& getTarget() { return targetPointer; }
	fm::string& getTargetQualifier() { return targetQualifier; }
